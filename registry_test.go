...
func TestRegistryAgents(t *testing.T) {
	...
	agents := r.Agents()
	jtesting.AssertEqual(t, len(agents), 2)
	jtesting.AssertEqual(t, agents[0], "blue")
	jtesting.AssertEqual(t, agents[1], "red")
}
...
func TestRegistryAgentsForRepo(t *testing.T) {
	r := &Registry{}
	r.Add("blue", "vicky", "url1")
	r.Add("red", "vicky", "url2")
	r.Add("green", "flux", "url3")

	agents := r.AgentsForRepo("vicky")
	jtesting.AssertEqual(t, len(agents), 2)
	jtesting.AssertEqual(t, agents[0], "blue")
	jtesting.AssertEqual(t, agents[1], "red")

	jtesting.AssertEqual(t, len(r.AgentsForRepo("nope")), 0)
}
